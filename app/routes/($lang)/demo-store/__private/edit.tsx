import { Form, Link, useActionData, useOutletContext, useTransition } from '@remix-run/react'
import type {
  Customer,
  CustomerUpdateInput,
...
import { assertApiErrors, getInputStyleClasses } from '../types'
// TODO: Uncomment for customers data
      ...
      <Form method="post">
        ...
        <div className="mt-3">
          ...
          {actionData?.fieldErrors?.email && (
            <p className="text-red-500 text-xs">{actionData.fieldErrors.email} &nbsp;</p>
          )}
        </div>
        ...
        {actionData?.fieldErrors?.currentPassword && (
          <p className="mt-1 text-red-500">{actionData.fieldErrors.currentPassword} &nbsp;</p>
        )}
        <Password
          name="newPassword"
          label="New password"
        ...
        />
        <p className={clsx('mt-1', actionData?.fieldErrors?.newPassword && 'text-red-500')}>
          Passwords must be at least 8 characters.
        </p>
        {actionData?.fieldErrors?.newPassword2 ? <br /> : null}
        {actionData?.fieldErrors?.newPassword2 && (
          <p className="mt-1 text-red-500">{actionData.fieldErrors.newPassword2} &nbsp;</p>
        )}
        <div className="mt-6">
          <Button
