...
import { json, redirect, type ActionFunction, type MetaFunction } from '@shopify/remix-oxygen'
import { useRef, useState } from 'react'
import { getInputStyleClasses } from '../types'
        ...
        <Form method="post" noValidate className="pt-6 pb-8 mt-4 mb-4 space-y-3">
          ...
          <div className="mb-3">
            ...
            {nativePasswordConfirmError && (
              <p className="text-red-500 text-xs"> {nativePasswordConfirmError} &nbsp;</p>
            )}
          </div>
